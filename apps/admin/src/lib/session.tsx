...
import { api, setAccessToken, REFRESH_STORAGE_KEY } from './api';
 ...
 *
 * Kept deliberately identical to the storefront's provider — same rotation, same
 * failure handling — because divergence between two auth implementations is how
