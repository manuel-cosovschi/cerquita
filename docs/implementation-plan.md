...
| Auditar el plan como se audita el código                | Dos líneas decían "hecho" de más: el chequeo de accesibilidad no incluía la consola, y "banear revoca sesiones al instante" era cierto pero no lo cubría ningún test. Un `✅` sin nada que lo vigile es una afirmación sobre el pasado, no una garantía. Los dos huecos se cerraron con tests, no bajando la afirmación. |
